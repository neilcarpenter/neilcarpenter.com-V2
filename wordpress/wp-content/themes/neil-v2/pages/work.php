				...
				<div class="row cf">
					<article class="grid-item grid-item-large" data-scroll-item>
						<a href="<?= get_site_url(); ?>/work/test-projjjj">
							...
							<h2 class="work-preview-client"><span class="wo"><span class="wi">Lurpak</span></span></h2>
							<h1 class="work-preview-name"><span class="wo"><span class="wi">Lurpak.co.uk</span></span></h1>
						</a>
					</article>
					<article class="grid-item grid-item-small" data-scroll-item>
						<a href="<?= get_site_url(); ?>/work/test-projjjj">
							...
							<h2 class="work-preview-client"><span class="wo"><span class="wi">Ikon Arts Management</span></span></h2>
							<h1 class="work-preview-name"><span class="wo"><span class="wi">Ikonarts.com</span></span></h1>
						</a>
					</article>
				</div>
